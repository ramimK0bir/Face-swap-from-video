class videoEditor :
    ...
    def swapFaceFromVideo( self,faceImage,videoPath,fpsFactor=2):
        ...
        self.addAudioToVideo('tempOutput.mp4' , videoPath,'finalOutput.mp4')
        self.os.remove("tempOutput.mp4")
        self.os.remove(videoPath)
        self.cleanup("images/")
        self.os.rename("finalOutput.mp4",videoPath)
        print(f"\n\n output video saved as {videoPath}")
